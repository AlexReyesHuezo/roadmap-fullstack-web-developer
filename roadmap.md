...
- Generate UIs with AI from Shadcn UI: [V0: From simple text prompts to appealing UIs](https://v0.dev/)

#### ![JavaScript](https://img.shields.io/badge/JavaScript-F7DF1E?style=for-the-badge&logo=javascript&logoColor=black)

- JavaScript Basics: [JavaScript Basics](https://developer.mozilla.org/en-US/docs/Learn/Getting_started_with_the_web/JavaScript_basics)
- JavaScript statements vs. expressions: [JavaScript statements vs. expressions](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements)
- JavaScript variables: [JavaScript variables](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements)
- JavaScript data types: [JavaScript data types](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures)
- JavaScript operators: [JavaScript operators](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators)
- JavaScript control flow: [JavaScript control flow](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Control_flow_and_error_handling)
- JavaScript functions: [JavaScript functions](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Functions)
- JavaScript objects: [JavaScript objects](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Working_with_Objects)
- JavaScript arrays: [JavaScript arrays](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Indexed_collections)
- JavaScript loops: [JavaScript loops](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Loops_and_iteration)
- JavaScript events: [JavaScript events](https://developer.mozilla.org/en-US/docs/Web/Events)
- JavaScript Promises: [JavaScript Promises](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise)
- JavaScript async/await: [JavaScript async/await](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/async_function)
- JavaScript modules: [JavaScript modules](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules)
- JavaScript xhr: [JavaScript xhr](https://developer.mozilla.org/en-US/docs/Web/API/XMLHttpRequest)
- JavaScript fetch: [JavaScript fetch](https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API)
- JavaScript DOM: [JavaScript DOM](https://developer.mozilla.org/en-US/docs/Web/API/Document_Object_Model)
- JavaScript browser events: [JavaScript browser events](https://www.freecodecamp.org/news/javascript-events-explained-in-simple-english/)
- JavaScript Web APIs: [JavaScript Web APIs](https://developer.mozilla.org/en-US/docs/Web/API)
- ECMAScript 262: [ECMAScript developint specification](https://github.com/tc39/ecma262)
- JavaScript data structures: [JavaScript data structures](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures)
- JavaScript oop: [JavaScript oop](https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Objects)
- JavaScript regular expressions: [JavaScript regular expressions](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions)
- JavaScript error handling: [JavaScript error handling](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Control_flow_and_error_handling)
- JavaScript debugging: [JavaScript debugging](https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Debugging)
- JavaScript testing: [JavaScript testing](https://developer.mozilla.org/en-US/docs/Learn/Tools_and_testing/Client-side_JavaScript_frameworks)
- JavaScript date and time: [JavaScript Date and time](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date)
- JavaScript internationalization: [JavaScript internationalization](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl)
- JavaScript security: [JavaScript security](https://developer.mozilla.org/en-US/docs/Web/Security)
- JavaScript performance: [JavaScript performance](https://developer.mozilla.org/en-US/docs/Web/Performance)
- JavaScript WebComponents: [Lenguajejs WebComponents](https://lenguajejs.com/webcomponents/)
- JavaScript visualized: [JavaScript visualized](https://dev.to/lydiahallie/series/3341)
- JavaScript functional programming: [JavaScript functional programming](https:/https://opensource.com/article/17/6/functional-javascript/eloquentjavascript.net/1st_edition/chapter6.html)
- JavaScript reactive programming: [JavaScript reactive programming](https://reactive.how/)
- JavaScript Interview Questions: [JavaScript Interview Questions](https://www.interviewbit.com/javascript-interview-questions/)
- JavaScript V8 Engine: [JavaScript V8 Engine](https://v8.dev/)
- Eloquente JavaScript: [Eloquente JavaScript](https://eloquentjavascript.net/)
- JavaScript Quiz: [JavaScript Quiz](https://www.w3schools.com/js/js_quiz.asp)
- JavaScript visualized: [JavaScript visualized](https://pythontutor.com/javascript.html#mode=edit)
- JavaScript package managers: [JavaScript package managers](https://www.freecodecamp.org/news/javascript-package-managers-101-9afd926add0a/)
- JavaScript Google style guide: [JavaScript style guide](https://google.github.io/styleguide/jsguide.html)
- JavaScript Standard Style: [JavaScript Standard Style](https://standardjs.com/)
- Vite tooling for JavaScript: [Vite tooling](https://vitejs.dev/)
- JavaScript with Astro: [JavaScript Astro](https://docs.astro.build/guides/using-javascript)
- JavaScript with SWC: [JavaScript SWC](https://swc.rs/docs/examples)
- JavaScript with Snowpack: [JavaScript Snowpack](https://www.snowpack.dev/)
- JavaScript with Parcel: [JavaScript Parcel](https://parceljs.org/)
- JavaScript with Rollup: [JavaScript Rollup](https://rollupjs.org/guide/en/)
- JavaScript with Webpack: [JavaScript Webpack](https://webpack.js.org/)
- JavaScript with Babel: [JavaScript Babel](https://babel.dev/)
